...
public class SystemNativeLibraryProperties(private val libraryName: String, private val propertyPrefix: String) :
    ...
    private operator fun get(property: String): String? =
        System.getProperty("$propertyPrefix$libraryName.$property", System.getProperty(propertyPrefix + property))
}
